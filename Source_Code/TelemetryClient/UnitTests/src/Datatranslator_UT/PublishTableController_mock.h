...
{
	PTC_DB_OPEN_SUCCESS = 0,			///< Success
	PTC_CONNECTION_FAILURE,			///< Failed to open the main connection
	PTC_SELECT_CONNECTION_FAILURE,	///< Failed to open the Select query connection
	PTC_UPDATE_CONNECTION_FAILURE,	///< Failed to open the Update query connection
	PTC_INSERT_CONNECTION_FAILURE,	///< Failed to open the Insert query connection
	PTC_DELETE_CONNECTION_FAILURE,	///< Failed to open the Delete query connection
	PTC_SELECT_QUERY_SUCCESS,		///< Select Query success
	PTC_SELECT_QUERY_FAILURE,		///< Failed to select data from the database
	PTC_DB_QUERY_SUCCESS,			///< Success in updating the database
	PTC_DB_QUERY_FAILURE			///< Failed to update the database
};
...
public:
	...
	PTC_DB_STATUS_CODE execSelectQuery(const string &strQuery, map<string, string> &arguments, QList<QMap<QString, QVariant>> &records);

	// Updating the database
	PTC_DB_STATUS_CODE  executeQuery(QSqlDatabase connectionName, const string &strQuery, map<string, string> &arguments);
