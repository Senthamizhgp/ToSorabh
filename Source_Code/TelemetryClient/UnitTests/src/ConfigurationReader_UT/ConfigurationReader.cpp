...
ConfigurationReader::ConfigurationReader() :
	m_sensorGlobalAcquisitionFreq(0),
	m_sensorEnable(0),
	m_sensorJson(""),
...
{	
	...
	m_sensorGlobalAcquisitionFreq = std::stoi(m_configParameters["SensorTelemetry"]["globalacquisitionfreq"]);
	...
	m_BLEEnable = std::stoi(m_configParameters["BLE"]["enable"]);
	m_BLEAcquisitionFreq = std::stoi(m_configParameters["BLE"]["acquisitionfreq"]);
	m_BLEJson = m_configParameters["BLE"]["json_header"];
	m_BLEExternalModuleEnable = std::stoi(m_configParameters["BLE"]["External Processing Unit"]);
	m_BLEPlugin1Enable = std::stoi(m_configParameters["BLE"]["External Plugin 1"]);
	m_BLEPlugin2Enable = std::stoi(m_configParameters["BLE"]["External Plugin 2"]);
	m_BLEPlugin3Enable = std::stoi(m_configParameters["BLE"]["External Plugin 3"]);
	m_RealSenseEnable = std::stoi(m_configParameters["RealSense"]["enable"]);
	m_RealSenseAcquisitionFreq = std::stoi(m_configParameters["RealSense"]["acquisitionfreq"]);
