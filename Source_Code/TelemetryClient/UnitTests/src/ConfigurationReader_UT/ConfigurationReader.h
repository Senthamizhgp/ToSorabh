...
public:
	...
	unsigned short m_sensorGlobalAcquisitionFreq;   ///< Holds global acquisition frequency of the sensors
	...
	unsigned short m_WiFiAcquisitionFreq;			///< Holds acquisition frequency for the WIFI
	...
	unsigned short m_RealSenseAcquisitionFreq;		///< Holds acquisition frequency for the Real Sense
