...
{
	DTC_DB_OPEN_SUCCESS,			///< Success in opening all the DTC connections
	DTC_CONNECTION_FAILURE,			///< Failed to open the DTC main connection
	DTC_SELECT_CONNECTION_FAILURE,	///< Failed to open the DTC Select query connection
	DTC_UPDATE_CONNECTION_FAILURE	///< Failed to open the DTC Update query connection
};
...
public:    
	...
	DBHandler *m_dbHandler;					///> Instance of the Database handler
